...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.4dbb3b1f783ee57d28200db4cc84ff90d02135a8c77945e4fa66602653aeb3a1.js',function(){input.required=false;search();});}
